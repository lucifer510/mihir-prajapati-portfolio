    ...
    >
      ...
      >
        ...
        <SectionHeader
          ...
          heading="About Me"
          description="Building scalable, reliable and secure APIs for smooth user experience."
          showUnderline={true}
          centered={true}
        />
                ...
                <div className="space-y-4 md:space-y-6">
                  ...
                  <div className="space-y-3 md:space-y-4 border-t border-gray-200/50 dark:border-gray-700/50 pt-4 md:pt-6">
                    ...
                    <p className="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                      ...
                      interactive, action-driven, and insightful Dashboards
                      using PowerBI . I believe in continuous learning and
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white break-all">
                      workwithmihirprajapati@gmail.com
                    </div>
                  </div>
                </motion.a>
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    text: "Built 5+ PowerBI Dashboards",
                    color: "text-blue-600",
                  },
                  {
                    icon: "solar:code-square-bold",
                    text: "Expert in API Integration",
